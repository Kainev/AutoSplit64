...
class CustomDetailWidget(QWidget):
    def __init__(self, parent=None):
        ...
        # Signals
        self._star_cb.stateChanged.connect(
            partial(self._set_option_enabled, self._star_cb, self._star_lb, self._star_sb))
        self._fadeout_cb.stateChanged.connect(
            partial(self._set_option_enabled, self._fadeout_cb, self._fadeout_lb, self._fadeout_sb))
        self._fadein_cb.stateChanged.connect(
            partial(self._set_option_enabled, self._fadein_cb, self._fadein_lb, self._fadein_sb))
        self._x_cam_cb.stateChanged.connect(
            partial(self._set_option_enabled, self._x_cam_cb, self._x_cam_lb, self._x_cam_sb))
